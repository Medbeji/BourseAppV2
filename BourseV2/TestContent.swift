...
class TestContent: UIView , UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout  {
    ...
    override init(frame: CGRect) {
        ...
        collectionView.registerClass(CustomCellFeed1.self, forCellWithReuseIdentifier: cellId)
...
class CustomCellFeed1 : BaseCell {
